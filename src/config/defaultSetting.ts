const defaultSetting: LX.AppSetting = {
  ...
  'player.isShowMusicCapsuleLyric': false,
  ...
  'download.savePath': '',
  'download.createArtistFolder': false,
  'download.createAlbumFolder': false,
  'download.writeMetadata': true,
  'download.writePicture': true,
  'download.writeLyric': true,
  'download.writeEmbedLyric': false,
  'download.writeRomaLyric': false,

  'sync.enable': false,
  'sync.webdav.enable': false,
  'sync.webdav.url': 'https://dav.jianguoyun.com/dav/',
  'sync.webdav.username': '',
  'sync.webdav.password': '',
  'sync.webdav.path': 'backup.json',
